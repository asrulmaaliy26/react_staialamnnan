...
const NewsDetail: React.FC = () => {
    ...
    const authorName = news.author || ('Redaksi ' + (news.jenjang || 'STAI Al-Mannan'));
    const unitName = news.fakultas || news.jenjang || 'STAI Al-Mannan';

    const handleShare = () => {
        if (navigator.share) {
            navigator.share({
                title: news.title || 'Berita STAI Al-Mannan',
